      ...
      <View style={styles.bgContainer}>
        ...
        <View style={styles.upperContainer}>
          ...
          <View style={styles.proofContainer}>
            ...
            />
            <View>
              <Text style={styles.prrofText}>NEW GRUB HOUSE</Text>
              <Text style={styles.detailText}> 5 members</Text>
            </View>
            ...
            <View style={styles.cardContainer}>
              ...
              <View style={{ justifyContent: "space-evenly" }}>
                <View style={styles.detailsContainer}>
                  ...
                  <Text style={styles.leftText}>£ 155</Text>
                </View>
                <View style={styles.detailsContainer}>
                  <View
                    style={{
                  ...
                  <Text style={styles.leftText}>£ 175</Text>
                </View>
                <View style={styles.detailsContainer}>
                  <View
                    style={{
                  ...
                  <Text style={styles.leftText}>£ 150</Text>
                </View>
                <View style={styles.detailsContainer}>
                  <View
                    style={{
                  ...
                  <Text style={styles.leftText}>£ 215</Text>
                </View>
                <View style={styles.detailsContainer}>
                  <View
                    style={{
                  ...
                  <Text style={styles.leftText}>£ 320</Text>
                </View>
